# This file was generated by the {rix} R package v0.17.2 on 2025-12-08
# with following call:
# >rix(date = c(latest,
#  > "2025-11-24",
#  > "2025-11-03",
...
let
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2025-11-03.tar.gz") { config.allowUnfree = true; };
  ...
  misc = pkgs.rPackages.buildRPackage {
    ...
    propagatedBuildInputs = builtins.attrValues {
      inherit (pkgs.rPackages) foreach doSNOW snow MASS;
    };
  };
  ...
  esgtoolkit = pkgs.rPackages.buildRPackage {
    ...
    postPatch = "rm -f src/*.o src/*.so src/*.dll";
    propagatedBuildInputs = [ misc ] ++ builtins.attrValues {
      inherit (pkgs.rPackages) ggplot2 gridExtra reshape2 VineCopula randtoolbox zoo data_table Rcpp;
    };
  };
  ...
  ahead = pkgs.rPackages.buildRPackage {
    ...
    postPatch = "rm -f src/*.o src/*.so src/*.dll";
    propagatedBuildInputs = [ misc ] ++ builtins.attrValues {
      inherit (pkgs.rPackages) Rcpp foreach snow forecast ggplot2 tseries randtoolbox;
    };
  };
  ...
  shell = pkgs.mkShell {
    ...
    buildInputs = [ btw misc esgtoolkit ahead ] ++ rpkgs ++ system_packages;
    shellHook = "
# =============================================================================
